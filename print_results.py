...
from read_news import read_cluster, get_dates_between, read_preprocessed_news
...
def print_story_clustering_per_day(news, date):
    ...
    events = story_clustering_to_events(news, w, t)
    f = open("C:/Users/User/Desktop/diploma/ner/results/story_clustering/" + date + ".txt", "w+", encoding="utf8")
...
d1 = datetime.date(2018, 10, 18)  # start date
...
for date in dates:
    ...
    print_story_clustering_per_day(news, date)
