...
from visualization import draw_graph3, communities_to_stories, show_graph_communities
...
def get_stories_for_news(news, events, dates, keywords_threshold, edges_threshold):
    ...
    show_graph_communities(G, partition, news)
...
def get_stories_for_dates(d1, d2):
    ...
    events = calculate_events_clusters(news, w, t)  # events = story_to_event_mapping(news)
